                        ...
                        <form action="<?php echo e(route('user.update.password')); ?>" method="POST">
                            ...
                            <div class="row mt-4">
                                <div class="col-xs-12 d-grid gap-2">
                                    <button class="btn sp_btn_success w-100" type="submit"><?php echo e(__('Update')); ?></button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php echo $__env->make(template().'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/caparptx/public_html/core/resources/views/theme3/user/auth/changepassword.blade.php ENDPATH**/ ?>