                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div id="image-preview" class="image-preview"
                                            style="background-image:url(<?php echo e(getFile('admins' ,'')); ?>);">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="username" class="form-control" required value="<?php echo e(old('username')); ?>">
                                    </div>
                                    ...
                                    <button class="btn btn-primary" type="admin"><?php echo e(__('Create Admin')); ?></button>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/caparptx/public_html/core/resources/views/backend/admins/create.blade.php ENDPATH**/ ?>