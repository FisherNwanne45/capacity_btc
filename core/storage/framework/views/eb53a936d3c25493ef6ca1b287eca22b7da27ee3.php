...
<?php $__env->startSection('content2'); ?>
    <div class="dashboard-body-part">
        ...
        <div class="d-flex flex-wrap justify-content-between mb-3">
            ...
            <a href="<?php echo e(route('user.change.password')); ?>" class="cmn-btn mb-2 text-dark"><i class="bi bi-shield-lock"></i> <?php echo e(__('Change Password')); ?></a>
        </div>
        <div class="site-card">
            <div class="card-body">
...
<?php echo $__env->make(template().'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/caparptx/public_html/core/resources/views/theme3/user/profile.blade.php ENDPATH**/ ?>